...
- **Redundant qualified providers** — backed by multiple independent eIDAS QTSPs with automatic failover, so timestamping never depends on a single provider staying up.
